        ...
        <div className="max-w-4xl mx-auto px-2 md:px-0">
          ...
          <div className="space-y-6">
            {jobs.map((job) => (
              <div
                key={job.id}
                className="flex flex-col bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition p-4 md:p-6 relative"
              >
                <div className="flex items-start">
                  ...
                  {/* Toggle Button */}
                  <button
                    className={`absolute top-4 right-4 text-blue-400 hover:text-blue-600 transition transform ${
